        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="badge badge-warning navbar-badge">{{ $notifies }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <span class="dropdown-item dropdown-header">{{$notifies}} Notifications</span>
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('notify.index') }}" class="dropdown-item">
                        <i class="fas fa-envelope mr-2"></i> {{$notifies}} new messages
