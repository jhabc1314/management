            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">修改节点</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('crontab.update', $crontab->id)}}" method="post">
                            {{csrf_field()}}
                            {{method_field('put')}}
                            <div class="card-body">
                                <label>IP mask:</label>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="cron_node_ip" value="{{$crontab->cron_node_ip}}"
                                               class="form-control"
                            ...
                            <div class="card-footer">
                                ...
                                <span class="text-danger">注意：修改以后需要 重启 才能生效</span>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
